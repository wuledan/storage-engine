...
| QD | IOPS (K) | P50 (μs) | P99 (μs) | P999 (μs) | Avg (μs) |
|----|----------|----------|----------|-----------|----------|
| 1 | 195 | 5.45 | 10.14 | 62.84 | 5.13 |
| 4 | 901 | 4.21 | 8.79 | 34.97 | 4.44 |
| 8 | 1,843 | 4.01 | 8.52 | 18.63 | 4.34 |
| 16 | 3,713 | 4.27 | 8.78 | 14.86 | 4.31 |
| 32 | 7,019 | 4.22 | 8.53 | 14.17 | 4.56 |
| 64 | 15,077 | 4.19 | 8.18 | 13.58 | 4.25 |
| 128 | 30,695 | 3.98 | 8.39 | 14.37 | 4.17 |
| 256 | **54,457** | 4.25 | 8.61 | 19.35 | 4.70 |

#### 分析

- **io_uring QD 扩展性更优**：支持到 QD=256，单线程 51.3M IOPS
- **libaio QD=256 吞吐最高**：54.5M IOPS，延迟仍然稳定在 4.25μs P50
- **libaio 低延迟更优**：QD=1 时 P50=5.45μs vs io_uring 的 8.49μs（SQ 提交开销）
